...
export const navItems = [
  ...
  { name: "Bank", path: "bank", icon: Landmark, roles: ["admin"] },
  { name: "Inventory", path: "inventory", icon: Fuel, roles: ["admin", "manager", "accountant"] },
  { name: "Expenses", path: "expenses", icon: Package, roles: ["admin"] },
  { name: "P & L", path: "pmspl", icon: TrendingUp, roles: ["admin"] },
  { name: "Audit", path: "profit-audit", icon: ClipboardCheck, roles: ["admin"] },
  {name: "Retained Earnings", path: "retained-earnings", icon: TrendingUp, roles: ["admin"]} 
];
